...
<div class="container">
    ...
    <form id="removeStudentForm">
        ...
        <button type="button" class="btn" onclick="submitRemoveStudent()">Remove Student</button>
    </form>
    <div id="message"></div>
</div>
...
<script>
    function submitRemoveStudent() {
        ...
        fetch('/admin/manageStudents/removeStudent', {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    document.getElementById('message').textContent = 'Failed to remove student: ' + data.error;
                }
            })
            .catch(error => {
                document.getElementById('message').style.display = 'block';
