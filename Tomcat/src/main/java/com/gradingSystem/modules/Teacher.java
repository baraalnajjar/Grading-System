...
public class Teacher {
    ...
    public String getCourses() {
        ...
        String query = "SELECT id, name, average, median, highest, lowest FROM course WHERE teacher_id = ?";
    ...
    public void updateStudentGrade(String studentId, String courseId, double newGrade) {
        try {
    ...
    public String toString() {
        return  "Username: " + username + ", Courses: " + courses.toString();
    }
}
